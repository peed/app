...
/*global Geo, Wikia, WikiaTrackerQueue */
...
(function (log, WikiaTrackerQueue, window, ghostwriter, document, Geo, LazyQueue, Cookies, Cache, Krux, abTest) {
	'use strict';
	...
	adProviderAdDriver2 = AdProviderAdDriver2(wikiaDart, scriptWriter, WikiaTrackerQueue, log, window, Geo, slotTweaker, Cache, adLogicHighValueCountry, adLogicDartSubdomain, abTest);
	adProviderEvolve = AdProviderEvolve(wikiaDart, scriptWriter, WikiaTrackerQueue, log, window, document, Krux, evolveHelper, slotTweaker);
	adProviderGamePro = AdProviderGamePro(wikiaDart, scriptWriter, WikiaTrackerQueue, log, window, document);
...
}(Wikia.log, WikiaTrackerQueue, window, ghostwriter, document, Geo, Wikia.LazyQueue, Wikia.Cookies, Wikia.Cache, Krux, Wikia.AbTest));
