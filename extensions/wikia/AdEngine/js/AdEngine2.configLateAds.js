 ...
 */
(function(log, WikiaTrackerQueue, window, ghostwriter, document, Geo, Krux) {
	var adConfig
		, scriptWriter
		, wikiaDart
		, slotTweaker
	...
	adProviderLiftium2Dom = AdProviderLiftium2Dom(WikiaTrackerQueue, log, document, slotTweaker, fakeLiftium, scriptWriter);
...
}(Wikia.log, WikiaTrackerQueue, window, ghostwriter, document, Geo, Krux));
